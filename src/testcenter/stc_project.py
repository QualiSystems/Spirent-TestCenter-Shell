...
class StcProject(StcObject):
    ...
    def clear_results(self, *ports):
        ...
        self.inter.perform('ResultsClearAllCommand',
                           PortList=build_obj_ref_list(self._get_ports(*ports)))
        self.inter.perform('ResultsClearAllProtocolCommand')
        time.sleep(1)
    ...
    def _command_generator(self, command, *ports):
        ...
        self.inter.perform(command, GeneratorList=build_obj_ref_list(generators))

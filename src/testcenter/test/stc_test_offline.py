"""
This module contains TestCenter package unit tests that can run in offline mode.
...
from stc_test_base import StcTestBase
...
class StcTestOffline(StcTestBase):
    ...
    def testAnalyzeConfig(self):
        ...
        self.stc.load_config(self.stc_config_files[0])

"""
This module implements classes and utility functions to manage TGN objects.

Any object that can be found in the TGN GUI (port, device, protocol etc.) is represented in the
TGN Tcl API as object.
"""
